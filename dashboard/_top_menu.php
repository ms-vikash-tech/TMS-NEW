        ...
        <button class="btn" id="menu-toggle" style="background: #fff;color:rgb(0,0,51);">&#9776;</button>
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0" >
            <li class="nav-item dropdown">
              <a href="#" style="text-decoration:none;" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <span>&#11167;</span>
               <b style="text-decoration:none;color:rgb(0,0,51);">UserName</b> 
              </a>
